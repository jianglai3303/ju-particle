...
define('AreaIni2d',['Particle','Effect','Vector2'],function(require, exports, mudule) {
    var Particle = require('Particle');
    var Effect = require('Effect');
    var Vector2 = require('Vector2');
...
define('ScatterIni2d',['Particle','Effect','Vector2'],function(require, exports, mudule) {
    var Particle = require('Particle');
    var Effect = require('Effect');
    var Vector2 = require('Vector2');
...
define('Resize',function(require,exports,mudule){
...
seajs.use(['Resize','ParticleSys', 'CanvasRender', 'WebglRender', 'AgeColor', 'Emit2d', 'PureColor', 'Vector3', 'Colorful', 'ScatterIni2d', 'SizeDes', 'Viberate','AreaIni2d','AirForce'], function(Resize, ParticleSys, CanvasRender, WebglRender, AgeColor,  Emit2d, PureColor, Vector3, Colorful, ScatterIni2d, SizeDes, Viberate, AreaIni2d, AirForce) {
